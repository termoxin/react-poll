...
var RadioButton = function (_a) {
    ...
    var Comp = value === text && status ? StyledRadio : semantic_ui_react_1.Radio;
    return (react_1.default.createElement(Comp, { status: status, label: text, name: "answer", value: text, checked: value === text, onChange: handleChange }));
};
