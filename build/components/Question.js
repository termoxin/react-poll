...
var Question = /** @class */ (function (_super) {
    ...
    function Question(props) {
        ...
        _this.handleChange = function (e, _a) {
            ...
            var _c = _this.state, status = _c.status, inputValue = _c.inputValue;
            ...
            if (type === "checkbox") {
                _this.setState({
                    inputValue: merge_1.default(inputValue, (_b = {}, _b[value] = checked, _b))
                });
            }
        ...
        _this.handleCheckAnswer = function () {
            ...
            if (type === "fill" || type === "radio") {
                ...
                var ca = correctAnswer.toLowerCase();
                var status_1 = iv === ca;
                _this.setState({
                    status: status_1
                });
            ...
            _this.setState({
                disabled: true
            }, function () { return handleChecking(_this.state.status, text); });
        };
        _this.state = {
            inputValue: "",
            status: null,
